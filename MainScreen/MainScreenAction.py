...
class MainScreen(QObject, Ui_Frame_containMainWindow):
    ...
    def SaveAndChangeSetting(self, settingDict):
        self.label_centerName.setText(self.__ConvertStringToUTF8String(settingDict["scName"]))
        self.label_deviceName.setText(self.__ConvertStringToUTF8String(settingDict["cenName"]))